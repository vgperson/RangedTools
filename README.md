...
However, because the "use tool" function in particular is completely overriden in many cases, it's possible that similar tool functionality mods operating in the same area may not work, or cause this mod to not work. I've added general fallbacks to resolve conflicts with Expanded Storage, Pipe Irrigation, and Hoe and Water Direction; other conflicts may or may not be resolvable on a case-by-case basis.
